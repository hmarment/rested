...
def test_integration_post(integration):
    ...
    r = integration._post("https://jsonplaceholder.typicode.com/posts", json=json)
    print(r.json())
...
def test_integration_put(integration):
    ...
    r = integration._put("https://jsonplaceholder.typicode.com/posts/1", json=json)
...
def test_integration_delete(integration):
    ...
    r = integration._delete("https://jsonplaceholder.typicode.com/posts/1")
    print(r.content)
    assert r.status_code == 200
